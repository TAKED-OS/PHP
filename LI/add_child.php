...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        $stmt = $conn->prepare("
            INSERT INTO children (name, age, gender, group_name, wishes, notes, birth_date)
            VALUES (?, ?, ?, ?, ?, ?, ?)
        ");
        ...
        if ($stmt->execute()) {
            $successMessage = "Ребёнок успешно добавлен.";
            ...
            $errors[] = "Ошибка при сохранении данных: " . $conn->error;
        }
    }
}
?>
                ...
                <form method="POST" class="child-form">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                minlength="2"
                                maxlength="150"
                                placeholder="Например: David Cohen"
                            >
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            name="wishes"
                            maxlength="1000"
                            placeholder="Например: хочет быть в комнате с Daniel"
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            name="notes"
                            maxlength="1000"
                            placeholder="Например: аллергия, особенности, комментарии"
                        ><?= htmlspecialchars($notes) ?></textarea>
                    </div>

                    <div class="form-actions">
                        <button type="submit" class="primary-button">Добавить ребёнка</button>
                    </div>
